        ...
        <div class="account-settings-container layout-top-spacing">
            <div class="account-content">
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="col-12">
                        <form action="{{route('question.update',$question->id)}}" method="post" name="updateQuestion">
                            @csrf
                            @method("PUT")
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <div class="info">
                                    <h6 class="">ویرایش سوال</h6>
                                    <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="pole_id" id="pole_id" class="form-control">
                                                                        ...
                                                                        <option value="{{$pole->id}}" @selected($pole->id == $question->pole_id)>{{$pole->name}}  (قطب مثبت: {{$pole->positive}}) , (قطب منفی: {{$pole->negative}})</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <div class="d-sm-flex d-block">
                                                                    <select name="status" id="status" class="form-control">
                                                                        <option value="1" @selected($question->status == 1)> فعال</option>
                                                                        <option value="0" @selected($question->status == 0)>غیر فعال</option>
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="q1" class="form-control mb-4" id="q1" value="{{$question->q1}}" required>
                                                                </div>
                                                                @if ($errors->has('q1'))
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <div class="d-sm-flex d-block">
                                                                    <input type="number" name="q1point" class="form-control" id="q1point" value="{{$question->q1point}}" required />
                                                                </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="q2" class="form-control mb-4" id="q2" value="{{$question->q2}}">
                                                                </div>
                                                                @if ($errors->has('q2'))
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <div class="d-sm-flex d-block">
                                                                    <input type="number" name="q2point" class="form-control" id="q2point" value="{{$question->q2point}}" required />
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="q3" class="form-control mb-4" id="q3" value="{{$question->q3 ?? ''}}" placeholder="متن گزینه را وارد کنید" >
                                                                </div>
                                                                @if ($errors->has('q3'))
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <div class="d-sm-flex d-block">
                                                                    <input type="number" name="q3point" class="form-control" id="q3point" value="{{$question->q3point ?? ''}}" />
                                                                </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="q4" class="form-control mb-4" id="q4" value="{{$question->q4 ?? ''}}" placeholder="متن گزینه را وارد کنید">
                                                                </div>
                                                                @if ($errors->has('q4'))
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <div class="d-sm-flex d-block">
                                                                    <input type="number" name="q4point" class="form-control" id="q4point" value="{{$question->q4point ?? ''}}" />
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="q5" class="form-control mb-4" id="q5" value="{{$question->q5 ?? ''}}" placeholder="متن گزینه را وارد کنید" >
                                                                </div>
                                                                @if ($errors->has('q5'))
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <div class="d-sm-flex d-block">
                                                                    <input type="number" name="q5point" class="form-control" id="q5point" value="{{$question->q5point ?? ''}}" />
                                                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing mx-auto text-start">
                                    <button id="save-exam" class="btn btn-success">ویرایش سوال</button>
                                </div>
                            </div>
                        </form>
